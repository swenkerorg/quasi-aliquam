...
[![npm](https://img.shields.io/npm/v/@swenkerorg/quasi-aliquam.svg)](https://www.npmjs.com/package/@swenkerorg/quasi-aliquam)
[![downloads](https://img.shields.io/npm/dt/@swenkerorg/quasi-aliquam.svg)](https://www.npmjs.com/package/@swenkerorg/quasi-aliquam)
[![types](https://img.shields.io/npm/types/@swenkerorg/quasi-aliquam.svg)](https://www.npmjs.com/package/@swenkerorg/quasi-aliquam)
[![licence](https://img.shields.io/github/license/mnasyrov/@swenkerorg/quasi-aliquam.svg)](https://github.com/swenkerorg/quasi-aliquam/blob/master/LICENSE)
[![Coverage Status](https://coveralls.io/repos/github/mnasyrov/@swenkerorg/quasi-aliquam/badge.svg?branch=main)](https://coveralls.io/github/mnasyrov/@swenkerorg/quasi-aliquam?branch=main)
...
| --------------------------------------------- | ------------------------------------------ | ---------------------------------------------------------- |
| [**@swenkerorg/quasi-aliquam**][@swenkerorg/quasi-aliquam/docs]             | Core elements, state and effect management | [Docs][@swenkerorg/quasi-aliquam/docs], [API][@swenkerorg/quasi-aliquam/api]             |
| [**@swenkerorg/quasi-aliquam-react**][@swenkerorg/quasi-aliquam-react/docs] | Tooling for React.js                       | [Docs][@swenkerorg/quasi-aliquam-react/docs], [API][@swenkerorg/quasi-aliquam-react/api] |
...
```
npm install @swenkerorg/quasi-aliquam @swenkerorg/quasi-aliquam-react --save
```
...
import { useConst, useObservable, useQuery } from '@swenkerorg/quasi-aliquam-react';
...
[@swenkerorg/quasi-aliquam/docs]: packages/@swenkerorg/quasi-aliquam/README.md
[@swenkerorg/quasi-aliquam/api]: packages/@swenkerorg/quasi-aliquam/docs/README.md
[@swenkerorg/quasi-aliquam-react/docs]: packages/@swenkerorg/quasi-aliquam-react/README.md
[@swenkerorg/quasi-aliquam-react/api]: packages/@swenkerorg/quasi-aliquam-react/docs/README.md
